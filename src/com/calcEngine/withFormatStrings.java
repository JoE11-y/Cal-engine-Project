...
public class withFormatStrings {


    // this program replaces the functionality of the string builder used in the sixth mode with string format method
    ...
    // this program contains an added functionality that prints out the result "7 * 5 = 35" if the above example is typed
